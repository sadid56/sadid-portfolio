...
const Contact = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {/* address */}
      <div  data-aos="zoom-in" className="grid md:grid-cols-3 gap-10 mx-3 bg-slate-900 p-10 rounded-md shadow-md bg-opacity-60">
        <div className="text-center space-y-1">
          <div className="w-10 mx-auto">
            <img src={phonePng} alt="" />
          </div>
          <h2 className="text-xl font-medium text-[#03e9f4]">WhatsApp</h2>
          <p className="text-gray-400 font-medium">
            <small>+880 1739859756</small>
          </p>
        </div>
        <div className="text-center space-y-1">
          <div className="w-10 mx-auto">
     ...
     data-aos-duration="2000" className="mt-10">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-center mt-5">
           {
            loading ?
             <button className="btn btn-disabled text-xl">Loading <span className="loading loading-spinner text-white"></span></button> :  <button
            type="submit"
