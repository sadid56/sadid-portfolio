...
<dialog id="my_modal_3" className="modal">
  <div className="modal-box bg-slate-900">
    <form method="dialog">
    <button style={{boxShadow: '0px 0px 10px 2px #03e9f4'}} className="btn btn-circle btn-sm border bg-transparent border-[#03e9f4] hover:bg-[#03e9f4] hover:text-white text-[#03e9f4] hover:border-white absolute right-2 top-2">X</button>
    </form>
